...
IP4=$(curl -sL -4 --max-time 3 ip.sb)
IP6=$(curl -sL -6 --max-time 3 ip.sb || echo "No IPv6")
CPU=`uname -m`
...
Download_snell(){
    ...
    archAffix
    DOWNLOAD_LINK="https://raw.githubusercontent.com/Rasta0501/Snell/main/snell-server-${VER}-linux-${CPU}.zip"
